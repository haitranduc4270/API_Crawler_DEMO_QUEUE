...
async function extractRss(url, configuration, version) {
  try {
    ...
    // eslint-disable-next-line global-require
    /*
    if (require('./index').isRequireProxy(url)) {           // cai nay nua van can day tai bo de demo thoi
    ...
    */
    ...
    $(itemSelector).each(function() {
      ...
      articles.push({
        title: entities.decode(title),                      // dong nay va dong duoi can de y nha van can day nhưng chay thu ko dc nen bo thoi
        //title: decode(title), 
    ...
    */
    ...
    blocksConfiguration.forEach(blockConfiguration => {
      ...
      $block(itemSelector).each(function() {
        ...
        if (link) {
          articles.push({
            title: entities.decode(title.trim()),  // dong nay va dong duoi can de y nha van can day nhưng chay thu ko dc nen bo thoi
